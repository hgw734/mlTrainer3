...
def fetch_historical_congress_trades(ticker: str) -> pd.DataFrame:
    """
    Fetch historical congressional trades for a specific ticker.
    ...
    try:
        logger.info(f"🏛️ Fetching historical congressional trades for {ticker}")
