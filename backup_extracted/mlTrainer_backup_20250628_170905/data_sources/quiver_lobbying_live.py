...
def fetch_live_lobbying_data() -> pd.DataFrame:
    """
    Fetch the latest lobbying disclosures from QuiverQuant.
    """
    ...
    try:
        logger.info("🏛️ Fetching live lobbying data from QuiverQuant")
