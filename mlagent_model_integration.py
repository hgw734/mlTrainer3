...
class MLAgentModelIntegration:
    ...
    def __init__(self):
        ...
        def _register_handlers(self):
            ...
            def parse_model_request(self, mltrainer_response: str) -> Dict[str, Any]:
                """Parse model execution requests from mlTrainer's response"""
                request = {"type": None, "model_id": None, "parameters": {}, "action": None}
                ...
                if "train model" in mltrainer_response.lower():
                    ...
                    for model_id in self.ml_manager.get_available_models():
                        ...
                        # Extract parameters
                        request["parameters"] = self._extract_ml_parameters(mltrainer_response)
                        ...
                        # Check for financial model requests
                            ...
                            for model_id in self.financial_manager.get_available_models():
                                if model_id.replace("_", " ") in mltrainer_response.lower():
                                    request["model_id"] = model_id
                                    break

                                # Extract parameters
                                request["parameters"] = self._extract_financial_parameters(mltrainer_response)
                                ...
                                # Check for model listing requests
                                    ...
                                    # Check for best models request
                                        ...
                                        def _extract_ml_parameters(self, response: str) -> Dict[str, Any]:
                                            ...
                                            if "symbol" in response or "stock" in response:
                                                ...
                                                symbol_match = re.search(r"(?:symbol|stock)[:\s]+([A-Z]{1,5})", response)
                                                if symbol_match:
                                                    ...
                                                    if "polygon" in response.lower():
                                                        params["data_source"] = "polygon"
                                                            ...
                                                            lookback_match = re.search(r"(\d+)\s*(?:days?|periods?)", response)
                                                            if lookback_match:
                                                                params["lookback_days"] = int(lookback_match.group(1))

                                                                return params

                                                                def _extract_financial_parameters(self, response: str) -> Dict[str, Any]:
                                                                    ...
                                                                    if "black-scholes" in response.lower():
                                                                        param_names = ["spot", "strike", "risk_free_rate", "volatility", "time_to_expiry"]
                                                                        for i, (name, value) in enumerate(zip(param_names, numbers[:5])):
                                                                                ...
                                                                                params["option_type"] = "put"
                                                                                    ...
                                                                                    # Portfolio parameters
                                                                                        ...
                                                                                        if symbols:
                                                                                            ...
                                                                                            # Risk-free rate
                                                                                            if numbers:
                                                                                                params["risk_free_rate"] = float(numbers[0]) / 100 if float(numbers[0]) > 1 else float(numbers[0])
                                                                                                ...
                                                                                                # VaR parameters
                                                                                                    ...
                                                                                                    if numbers:
                                                                                                        ...
                                                                                                        for num in numbers:
                                                                                                            if 0 < float(num) < 1:
                                                                                                                params["confidence_level"] = float(num)
                                                                                                                elif 90 <= float(num) <= 99:
                                                                                                                    params["confidence_level"] = float(num) / 100

                                                                                                                    return params

                                                                                                                    def execute_model_request(self, request: Dict[str, Any]) -> Dict[str, Any]:
                                                                                                                        """Execute a model request and return results"""
                                                                                                                        try:
                                                                                                                            if request["type"] == "ml" and request["action"] == "train":
                                                                                                                                return self._execute_ml_model(request)

                                                                                                                                elif request["type"] == "financial" and request["action"] == "run":
                                                                                                                                    return self._execute_financial_model(request)
                                                                                                                                        ...
                                                                                                                                        return self._handle_info_request(request)
                                                                                                                                            ...
                                                                                                                                            return {"success": False, "error": "Unknown request type"}
                                                                                                                                                ...
                                                                                                                                                def _execute_ml_model(self, request: Dict[str, Any]) -> Dict[str, Any]:
                                                                                                                                                    ...
                                                                                                                                                    def _execute_financial_model(self, request: Dict[str, Any]) -> Dict[str, Any]:
                                                                                                                                                        """Execute financial model"""
                                                                                                                                                        model_id = request["model_id"]
                                                                                                                                                        params = request["parameters"]

                                                                                                                                                        # Run model
                                                                                                                                                        result = self.financial_manager.run_model(model_id, **params)
                                                                                                                                                        ...
                                                                                                                                                        if result.option_price is not None:
                                                                                                                                                            response["option_price"] = result.option_price
                                                                                                                                                            response["greeks"] = result.greeks
                                                                                                                                                            ...
                                                                                                                                                            if result.portfolio_weights is not None:
                                                                                                                                                                ...
                                                                                                                                                                if result.risk_metrics:
                                                                                                                                                                    response["risk_metrics"] = result.risk_metrics

                                                                                                                                                                    if result.predictions is not None:
                                                                                                                                                                        # For large arrays, just return summary statistics
                                                                                                                                                                        if isinstance(result.predictions, np.ndarray):
                                                                                                                                                                            ...
                                                                                                                                                                            def _handle_info_request(self, request: Dict[str, Any]) -> Dict[str, Any]:
                                                                                                                                                                                ...
                                                                                                                                                                                if request["action"] == "list":
                                                                                                                                                                                    ...
                                                                                                                                                                                    "models": self.financial_manager.get_available_models(),
                                                                                                                                                                                        ...
                                                                                                                                                                                        best_ml = self.ml_manager.get_best_models(top_n=5)

                                                                                                                                                                                        return {
                                                                                                                                                                                        "success": True,
                                                                                                                                                                                        "best_ml_models": [{"model_id": model_id, "r2_score": score} for model_id, score in best_ml],
                                                                                                                                                                                        }

                                                                                                                                                                                        return {"success": False, "error": "Unknown info request"}

                                                                                                                                                                                        def format_response_for_mltrainer(self, execution_result: Dict[str, Any]) -> str:
                                                                                                                                                                                            ...
                                                                                                                                                                                            if not execution_result.get("success"):
                                                                                                                                                                                                ...
                                                                                                                                                                                                # ML model results
                                                                                                                                                                                                if execution_result.get("model_type") == "ml":
                                                                                                                                                                                                    lines.append(f"✅ ML Model '{execution_result['model_id']}' trained successfully!")
                                                                                                                                                                                                    lines.append(f"Training time: {execution_result['training_time']:.2f} seconds")

                                                                                                                                                                                                    if execution_result.get("performance"):
                                                                                                                                                                                                        perf = execution_result["performance"]
                                                                                                                                                                                                        lines.append("\nPerformance Metrics:")
                                                                                                                                                                                                        lines.append(f"  • R² Score: {perf.get('r2_score', 0):.4f}")
                                                                                                                                                                                                        lines.append(f"  • RMSE: {perf.get('rmse', 0):.4f}")
                                                                                                                                                                                                        lines.append(f"  • MAE: {perf.get('mae', 0):.4f}")
                                                                                                                                                                                                        lines.append(f"  • Directional Accuracy: {perf.get('directional_accuracy', 0):.2%}")

                                                                                                                                                                                                        # Financial model results
                                                                                                                                                                                                        elif execution_result.get("model_type") == "financial":
                                                                                                                                                                                                            lines.append(f"✅ Financial Model '{execution_result['model_id']}' executed successfully!")

                                                                                                                                                                                                            if "option_price" in execution_result:
                                                                                                                                                                                                                lines.append(f"\nOption Price: ${execution_result['option_price']:.2f}")
                                                                                                                                                                                                                if execution_result.get("greeks"):
                                                                                                                                                                                                                    lines.append("Greeks:")
                                                                                                                                                                                                                    for greek, value in list(execution_result["greeks"].items()):
                                                                                                                                                                                                                        lines.append(f"  • {greek.capitalize()}: {value:.4f}")

                                                                                                                                                                                                                        if "portfolio_weights" in execution_result:
                                                                                                                                                                                                                            lines.append("\nOptimal Portfolio Weights:")
                                                                                                                                                                                                                            weights = execution_result["portfolio_weights"]
                                                                                                                                                                                                                            for i, weight in enumerate(weights):
                                                                                                                                                                                                                                lines.append(f"  • Asset {i+1}: {weight:.2%}")

                                                                                                                                                                                                                                if execution_result.get("performance_metrics"):
                                                                                                                                                                                                                                    metrics = execution_result["performance_metrics"]
                                                                                                                                                                                                                                    lines.append("\nPortfolio Performance:")
                                                                                                                                                                                                                                    lines.append(f"  • Expected Return: {metrics.get('expected_return', 0):.2%}")
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    if "risk_metrics" in execution_result:
                                                                                                                                                                                                                                        lines.append("\nRisk Metrics:")
                                                                                                                                                                                                                                        for metric, value in list(execution_result["risk_metrics"].items()):
                                                                                                                                                                                                                                            if isinstance(value, (int, float)):
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                # Info results
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    lines.append(f"Categories: {', '.join(execution_result['ml_models']['categories'])}")
                                                                                                                                                                                                                                                    lines.append(f"\nFinancial Models: {execution_result['financial_models']['total']} models")
                                                                                                                                                                                                                                                    lines.append("Available: " + ", ".join(execution_result["financial_models"]["models"]))

                                                                                                                                                                                                                                                    elif "best_ml_models" in execution_result:
                                                                                                                                                                                                                                                        lines.append("🏆 Best Performing ML Models:")
                                                                                                                                                                                                                                                        for model in execution_result["best_ml_models"]:
                                                                                                                                                                                                                                                            lines.append(f"  • {model['model_id']}: R² = {model['r2_score']:.4f}")
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            def get_model_recommendations(self, context: Dict[str, Any]) -> List[str]:
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                if "prediction" in objective or "forecast" in objective:
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    if "portfolio" in objective:
                                                                                                                                                                                                                                                                        recommendations.append("For portfolio optimization, use: mean_variance or risk_parity")

                                                                                                                                                                                                                                                                        if "option" in objective:
                                                                                                                                                                                                                                                                            recommendations.append("For option pricing, use: black_scholes")

                                                                                                                                                                                                                                                                            if "risk" in objective:
                                                                                                                                                                                                                                                                                recommendations.append("For risk assessment, use: value_at_risk or stress_testing")

                                                                                                                                                                                                                                                                                if "trading" in objective or "strategy" in objective:
                                                                                                                                                                                                                                                                                    recommendations.append("For trading strategies, try: ma_crossover or rsi_strategy")
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    def get_model_integration() -> MLAgentModelIntegration:
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        if _model_integration is None:
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            # Update mlAgent bridge to use model integration
                                                                                                                                                                                                                                                                                            def enhance_mlagent_with_models():
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                # Add model parsing to mlAgent
                                                                                                                                                                                                                                                                                                original_parse = mlagent.parse_mltrainer_response

                                                                                                                                                                                                                                                                                                def enhanced_parse(mltrainer_response: str) -> Dict[str, Any]:
                                                                                                                                                                                                                                                                                                    # First try original parsing
                                                                                                                                                                                                                                                                                                    result = original_parse(mltrainer_response)

                                                                                                                                                                                                                                                                                                    # Then check for model requests
                                                                                                                                                                                                                                                                                                    model_request = integration.parse_model_request(mltrainer_response)
                                                                                                                                                                                                                                                                                                    if model_request["model_id"] or model_request["action"]:
                                                                                                                                                                                                                                                                                                        # Execute model request
                                                                                                                                                                                                                                                                                                        execution_result = integration.execute_model_request(model_request)

                                                                                                                                                                                                                                                                                                        # Add formatted response to trials
                                                                                                                                                                                                                                                                                                        model_response = integration.format_response_for_mltrainer(execution_result)
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        if "trial_suggestions" not in result:
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            logger.info("mlAgent enhanced with model execution capabilities")
