                    ...
                    with open("logs/unified_chat_history.json", "w") as f:
                        ...
                        def add_message_with_memory(
                            ...
                            if "messages" not in st.session_state:
                                ...
                                def main():
                                    st.set_page_config(
                                        page_title="mlTrainer Unified",
                                        page_icon="🤖",
                                        layout="wide",
                                        initial_sidebar_state="collapsed")

                                    # Mobile-optimized CSS from advanced
                                    # version
                                    st.markdown(
                                        """
                                    <style>
                                    ...
                                    if "messages" not in st.session_state:
                                        ...
                                        with st.sidebar:
                                            ...
                                            with st.expander("Goal Settings", expanded=True):
                                                new_goal = st.text_area("Current Goal", value=current_goal.get(
                                                    "goal", ""), help="Define the system's primary objective")

                                                if st.button(
                                                        "Update Goal", type="primary"):
                                                    components["goal_system"].set_goal(
                                                        new_goal)
                                                    st.success(
                                                    ...
                                                    if current_goal.get(
                                                        ...
                                                        for req in current_goal["compliance_requirements"]:
                                                            ...
                                                            active_trials = [
                                                                t for t in trials if t.get("status") not in [
                                                                    ...
                                                                    with st.container():
                                                                        ...
                                                                        with col2:
                                                                            if trial["status"] == "pending_approval":
                                                                                if st.button(
                                                                                        "✓", key=f"approve_{trial['trial_id']}"):
                                                                                    components["background_manager"].approve_trial(
                                                                                        trial["trial_id"])
                                                                                    st.rerun()
                                                            else:
                                                                st.info(
                                                            ...
                                                            st.divider()
                                                             ...
                                                             st.subheader(
                                                              ...
                                                              active_recs = components["recommendation_tracker"].get_active_recommendations(
                                                               ...
                                                               if active_recs:
                                                                    st.metric(
                                                                        "Active Recommendations", len(active_recs))
                                                                    ...
                                                                    for rec in active_recs[:5]:
                                                                        with st.expander(f"{rec['symbol']} - {rec['timeframe']}", expanded=True):
                                                                            ...
                                                                            with col1:
                                                                                st.metric(
                                                                                    "Signal Strength", f"{rec['signal_strength']:.1%}")
                                                                                st.metric(
                                                                                    "Entry Price", f"${rec['entry_price']:.2f}")

                                                                            with col2:
                                                                                st.metric(
                                                                                    "Profit Probability", f"{rec['profit_probability']:.1%}")
                                                                                st.metric(
                                                                                    "Target Price", f"${rec['target_price']:.2f}")
                                                                            ...
                                                                            # button
                                                                            if st.button(
                                                                                    f"Add to Watch List", key=f"watch_{rec['symbol']}_{rec['timestamp']}"):
                                                                                st.success(
                                                                                    f"Added {rec['symbol']} to watch list!")
                                                                else:
                                                                    st.info(
                                                                        "No active recommendations. Run a scan to generate recommendations.")
                                                                ...
                                                                with col1:
                                                                    st.metric(
                                                                        "Portfolio Value", f"${portfolio_metrics['total_value']:,.2f}")
                                                                    st.metric(
                                                                        "Open Positions", portfolio_metrics['open_positions'])

                                                                with col2:
                                                                    st.metric(
                                                                        "Total Return",
                                                                        f"{portfolio_metrics['total_return_pct']:+.2f}%",
                                                                        delta=f"${portfolio_metrics['total_return']:,.2f}")
                                                                    st.metric(
                                                                        "Closed Trades", portfolio_metrics['closed_positions'])

                                                                with col3:
                                                                    st.metric(
                                                                        "Win Rate", f"{portfolio_metrics['win_rate']:.1f}%")
                                                                    st.metric(
                                                                        "Avg Win", f"{portfolio_metrics['avg_win_pct']:+.2f}%")
                                                                ...
                                                                if st.button(
                                                                    ...
                                                                    st.text_area(
                                                                        "Performance Report", report, height=300)
                                                                ...
                                                                col1, col2 = st.columns(
                                                                    2)
                                                                with col1:
                                                                    st.metric("Total Models", executor_summary.get(
                                                                        "registered_actions", 0))
                                                                    with col2:
                                                                        st.metric("Executions", executor_summary.get(
                                                                            "total_executions", 0))
                                                                        ...
                                                                        st.subheader(
                                                                            "🧠 Memory Status")
                                                                        st.caption(
                                                                            "Chat History: " + str(len(st.session_state.messages)) + " messages")
                                                                        ...
                                                                        if st.button(
                                                                                "📊 Portfolio Analysis", use_container_width=True):
                                                                            st.session_state.quick_action = "portfolio_analysis"

                                                                            if st.button(
                                                                                    "🎯 Momentum Screening", use_container_width=True):
                                                                                ...
                                                                                if st.button(
                                                                                    ...
                                                                                    if st.button(
                                                                                            "🔍 Market Regime", use_container_width=True):
                                                                                        st.session_state.quick_action = "regime_detection"

                                                                                        if st.button(
                                                                                                "🗑️ Clear Chat", type="secondary", use_container_width=True):
                                                                                            st.session_state.messages = []
                                                                                            save_chat_history(
                                                                                                [])
                                                                                            st.rerun()
                                                                                            ...
                                                                                            # interface
                                                                                            st.title(
                                                                                                "🤖 mlTrainer Unified Interface")

                                                                                            # Display
                                                                                            # update
                                                                                            # status
                                                                                            if os.path.exists(
                                                                                                    "/data/recommendations/last_scan_time.json"):
                                                                                                try:
                                                                                                    with open("/data/recommendations/last_scan_time.json", "r") as f:
                                                                                                        ...
                                                                                                        if minutes_ago < 1:
                                                                                                            ...
                                                                                                            st.info(
                                                                                                                f"🕒 Last update: {minutes_ago} minutes ago")
                                                                                            ...
                                                                                            if current_goal.get(
                                                                                                ...
                                                                                                if "quick_action" in st.session_state:
                                                                                                    ...
                                                                                                    if action in quick_prompts:
                                                                                                        user_input = quick_prompts[
                                                                                                            action]
                                                                                                        add_message_with_memory(
                                                                                                            "user", user_input)
                                                                                                        ...
                                                                                                        with st.spinner("mlTrainer is thinking# Production code implemented"):
                                                                                                            ...
                                                                                                            for message in st.session_state.messages:
                                                                                                                ...
                                                                                                                if role == "user":
                                                                                                                    st.markdown(
                                                                                                                        f'<div class="user-message">👤 <strong>You:</strong><br>{content}</div>',
                                                                                                                        unsafe_allow_html=True )
                                                                                                                    else:
                                                                                                                        # Parse
                                                                                                                        # for
                                                                                                                        # executable
                                                                                                                        # actions
                                                                                                                        parsed = components["bridge"].parse_mltrainer_response(
                                                                                                                            content)
                                                                                                                        ...
                                                                                                                        # if
                                                                                                                        # found
                                                                                                                        if parsed.get("executable") and (parsed.get(
                                                                                                                                "trial_suggestions") or parsed.get("models_mentioned")):
                                                                                                                                        ...
                                                                                                                                        for suggestion in parsed[
                                                                                                                                            ...
                                                                                                                                            if parsed.get(
                                                                                                                                                ...
                                                                                                                                                for model in parsed[
                                                                                                                                                    ...
                                                                                                                                                    with col2:
                                                                                                                                                        if st.button(
                                                                                                                                                                "🚀 Execute", key=f"exec_{message.get('timestamp', '')}"):
                                                                                                                                                            # Start
                                                                                                                                                            # background
                                                                                                                                                            # trial
                                                                                                                                                            trial_id = components["background_manager"].start_trial(
                                                                                                                                                                content, auto_approve=False)
                                                                                                                                                            if trial_id:
                                                                                                                                                                st.success(
                                                                                                                                                                    f"Trial {trial_id} created! Check sidebar for approval.")
                                                                                                                                                                else:
                                                                                                                                                                    st.error(
                                                                                                                                                                        "Failed to create trial. Check compliance.")
                                                                                                                                                                    st.rerun()

                                                                                                                                                                    # Chat
                                                                                                                                                                    # input
                                                                                                                                                                    user_input = st.chat_input(
                                                                                                                                                                        "Ask mlTrainer anything# Production code implemented")
                                                                                                                                                                    ...
                                                                                                                                                                    if user_input:
                                                                                                                                                                        ...
                                                                                                                                                                        with st.spinner("mlTrainer is processing# Production code implemented"):
                                                                                                                                                                            try:
                                                                                                                                                                                ...
                                                                                                                                                                                # executable
                                                                                                                                                                                # actions
                                                                                                                                                                                parsed = components["executor"].parse_mltrainer_response(
                                                                                                                                                                                    response)
                                                                                                                                                                                if parsed[
                                                                                                                                                                                        "executable"]:
                                                                                                                                                                                    # Automatically
                                                                                                                                                                                    ...
                                                                                                                                                                                    if trial_id:
                                                                                                                                                                                        st.toast(
                                                                                                                                                                                            f"Trial {trial_id} ready for review!", icon="🎯")

                                                                                                                                                                                        except Exception as e:
                                                                                                                                                                                            st.error(
                                                                                                                                                                                                f"Error: {str(e)}")
                                                                                                                                                                                            add_message_with_memory(
                                                                                                                                                                                                "system", f"Error occurred: {str(e)}")
                                                                                                                                                                                            ...
                                                                                                                                                                                            with st.container():
                                                                                                                                                                                                ...
                                                                                                                                                                                                with col1:
                                                                                                                                                                                                    st.caption("**Models Available:** " + str(
                                                                                                                                                                                                        components["executor"].get_execution_summary()["registered_actions"]))
