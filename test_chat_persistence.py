...
This test will:
    ...
    {"role": "mltrainer", "content": "Response 1", "timestamp": datetime.now().isoformat()},
    {"role": "user", "content": "execute", "timestamp": datetime.now().isoformat()},
    ]

    # Save to disk
    with open(CHAT_HISTORY_FILE, "w") as f:
        json.dump({"messages": test_messages, "saved_at": datetime.now().isoformat(), "max_messages": 200}, f, indent=2)
        ...
        if CHAT_HISTORY_FILE.exists():
            ...
            print(f"✅ File size: {file_size} bytes")
                ...
                with open(CHAT_HISTORY_FILE, "r") as f:
                    ...
                    print(f"✅ Max messages setting: {loaded_data['max_messages']}")
                    ...
                    for i, msg in enumerate(loaded_data["messages"], 1):
                        ...
                        print(f"✅ Deque limited to {len(limited_messages)} messages")
                        print(f"✅ First message: {limited_messages[0]['content']}")
                        print(f"✅ Last message: {limited_messages[-1]['content']}")
                        ...
                        with open(LOGS_DIR / "test_200_limit.json", "w") as f:
                            ...
                            print(f"📁 Check the logs directory to see the actual files created")
