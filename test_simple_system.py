            ...
            if retrieved:
                print(f"✅ Trial retrieved: {retrieved.trial_id}")
                    ...
                    try:
                        ...
                        print(
                            f"✅ Engine initialized with {engine.max_workers} workers")

                        # Test task creation
                        tasks = engine._create_execution_tasks(
                            [{"action": "test1", "params": {}}, {"action": "test2", "params": {}}])
                        print(f"✅ Created {len(tasks)} execution tasks")
                            ...
                            try:
                                ...
                                action = generator.generate_action("Calculate SMA indicator", {
                                                                   "indicator": "sma", "period": 20})
                                if action:
                                    print(
                                        "✅ Successfully generated dynamic action")
                                        ...
                                        try:
                                            ...
                                            feedback = TrialFeedback(
                                                trial_id="test_fb_001", action_type="test_action", parameters={
                                                    "param": 1}, outcome="success", performance_metrics={
                                                    "accuracy": 0.95}, execution_time=1.0, )
                                            ...
                                            print(
                                                f"✅ Tracking {summary['total_trials']} trials")

                                            except Exception as e:
                                                print(
                                                    f"❌ Feedback manager error: {e}")
                                                ...
                                                try:
                                                    ...
                                                    goal_system.set_goal(
                                                        "Test goal for system verification")
                                                    current = goal_system.get_current_goal()
                                                    print(
                                                        f"✅ Goal system working: '{current['goal']}'")

                                                    except Exception as e:
                                                        print(
                                                            f"❌ Goal system error: {e}")
                                                        ...
                                                        try:
                                                            ...
                                                            print(
                                                                f"✅ Memory system working: {stats['total_messages']} messages")
                                                                ...
                                                                try:
                                                                    ...
                                                                    enhanced.add_interaction(
                                                                        "user", "test", "assistant", "response")

                                                                    stats = enhanced.get_memory_stats()
                                                                    print(
                                                                        f"✅ Enhanced memory working: {stats['short_term_count']} short-term memories")

                                                                    except Exception as e:
                                                                        print(
                                                                            f"❌ Enhanced memory error: {e}")
                                                                        ...
                                                                        try:
                                                                            ...
                                                                            # data
                                                                            # source
                                                                            polygon_ok = compliance.verify_data_source(
                                                                                "polygon")
                                                                            synthetic_ok = compliance.verify_data_source(
                                                                                "synthetic")

                                                                            print(
                                                                                f"✅ Polygon approved: {polygon_ok}")
                                                                            print(
                                                                                f"✅ Synthetic blocked: {not synthetic_ok}")

                                                                            # Test
                                                                            # model
                                                                            # execution
                                                                            result = compliance.verify_model_execution(
                                                                                "test_model", {"param": 1}, "polygon")
                                                                            print(
                                                                                f"✅ Model execution check: {result['approved']}")
                                                                                        ...
                                                                                        print(
                                                                                            ...
                                                                                            print(
                                                                                                ...
                                                                                                try:
                                                                                                    ...
                                                                                                    print(
                                                                                                        "✅ Data connector modules found")
                                                                                                    except Exception as e:
                                                                                                        print(
                                                                                                            f"⚠️ Data connectors not available: {e}")
