...
mltrainer_image = (
    ...
    .env(
        {"PYTHONUNBUFFERED": "1", "STREAMLIT_SERVER_HEADLESS": "true",
...
def get_container_count():
    ...
    def cache_service():
        ...
        def run_streamlit():
            ...
            @stub.function(image=mltrainer_image,
                           shared_volumes={"/models": model_volume,
                                           "/cache": cache_volume,
                                           "/data": data_volume},
                           cpu=1.0,
                           memory=2048,
            ...
            async def api_endpoint(request: Dict[str, Any]):
                ...
                if cached_result:
                    ...
                    @stub.function(
                        image=mltrainer_image,
                        shared_volumes={
                            "/models": model_volume, "/data": data_volume},
                                ...
                                async def optimize_and_cleanup():
                                    ...
                                    def _preload_models():
                                        ...
                                        models_to_preload = get_config(
                                            "optimization.preload_models", [
                                                "random_forest_default", "lstm_basic", "xgboost_balanced"])
                                        ...
                                        for model_name in models_to_preload:
                                            try:
                                                _load_model_to_memory(
                                                    ...
                                                    logger.error(
                                                        f"Failed to preload {model_name}: {e}")
                                                    ...
                                                    async def _get_cache_connection():
                                                        ...
                                                        def _get_ml_engine():
                                                            ...
                                                            if not hasattr(
                                                                    _get_ml_engine, "_instance"):
                                                                from ml_engine_real import RealMLEngine

                                                                _get_ml_engine._instance = RealMLEngine(
                                                                    cache_enabled=True, connection_pool_size=20)
                                                                ...
                                                                def deploy():
                                                                    ...
                                                                    logger.info(
                                                                        "🚀 Deploying optimized mlTrainer to Modal# Production code implemented")
                                                                    logger.info(
                                                                    ...
                                                                    logger.info(
                                                                        "  - Health: https://monitor.mltrainer.windfuhr.net/health")
