                    ...
                    for response in proper_responses:
                        try:
                            ...
                            print(f"✅ PASSED: '{response[:50]}...'")
                                ...
                                print(f"❌ FAILED: Should have allowed: '{response}'")
                                ...
                                def test_action_statements_with_plan():
                                    ...
                                    for response in planned_responses:
                                        try:
                                            verify_response(response)
                                            print(f"✅ PASSED: Plan with permission request")
                                            except SystemExit:
                                                print(f"❌ FAILED: Should have allowed planned response")


                                                def main():
                                                    print("🔒 PERMISSION ENFORCEMENT VERIFICATION")
                                                    print(("=" * 50))
                                                    print("Testing the 'ask and wait for confirmation' rule")
                                                    ...
                                                    print(("\n" + "=" * 50))
                                                    print("✅ Permission enforcement is working correctly!")
                                                    print("🚨 The system blocks all actions without explicit permission")
