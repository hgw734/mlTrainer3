                ...
                def test_response_violations():
                    ...
                    for response in test_responses:
                        try:
                            ...
                            print(f"   Content: {response[:50]}# Production code implemented")
                            except SystemExit as e:
                                print(f"✅ BLOCKED: Response with forbidden content")
                                print(f"   Sample: {response[:50]}# Production code implemented")
                                    ...
                                    for prompt in compliant_prompts:
                                        try:
                                            ...
                                            print(f"✅ PASSED: '{prompt}'")
                                                ...
                                                print(f"❌ FAILED: '{prompt}' should have passed!")
                                                ...
                                                def calculate_moving_average(data: pd.Series, window: int) -> pd.Series:
                                                    if window <= 0:
                                                        ...
                                                        try:
                                                            verify_response(compliant_response)
                                                            print(f"✅ PASSED: Compliant code response")
                                                            except SystemExit:
                                                                print(f"❌ FAILED: Compliant response was rejected!")


                                                                def main():
                                                                    print("🔒 COMPLIANCE ENFORCEMENT VERIFICATION")
                                                                    print(("=" * 50))
                                                                    ...
                                                                    # production compliant content
                                                                    test_compliant_content()

                                                                    print(("\n" + "=" * 50))
                                                                    print("✅ Compliance enforcement is working correctly!")
                                                                    print("🚨 The system blocks all non-compliant content")
