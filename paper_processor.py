                    ...
                    try:
                        with open(PAPER_INDEX_FILE, "r") as f:
                            ...
                            def _save_index(self):
                                ...
                                self.paper_index["last_updated"] = datetime.now().isoformat()
                                                            ...
                                                            try:
                                                                ...
                                                                for page in reader.pages:
                                                                    full_text += page.extract_text() + "\n"
                                                                        ...
                                                                        return {"success": False, "error": f"Failed to read PDF: {e}", "paper_id": paper_id}

                                                                        # Extract key information
                                                                        extracted_data = self._extract_information(full_text)
                                                                        ...
                                                                        # Save processed text
                                                                        processed_file = PROCESSED_DIR / f"{paper_id}.txt"
                                                                        with open(processed_file, "w", encoding="utf-8") as f:
                                                                            ...
                                                                            return {"success": True, "paper_id": paper_id, "extracted": extracted_data, "text_file": str(processed_file)}
                                                                                    ...
                                                                                    if "application/pdf" in response.headers.get("content-type", ""):
                                                                                        ...
                                                                                        with open(pdf_path, "wb") as f:
                                                                                            ...
                                                                                            return self.process_pdf(pdf_path)
                                                                                                ...
                                                                                                # Process as HTML/text
                                                                                                text = response.text
                                                                                                # Simple HTML stripping (real implementation would use BeautifulSoup)
                                                                                                text = re.sub(r"<[^>]+>", "", text)
                                                                                                ...
                                                                                                with open(processed_file, "w", encoding="utf-8") as f:
                                                                                                    ...
                                                                                                    "text_file": str(processed_file),
                                                                                                        ...
                                                                                                        return {"success": False, "error": f"Failed to process URL: {e}", "paper_id": paper_id}
                                                                                                        ...
                                                                                                        def _extract_information(self, text: str) -> Dict[str, Any]:
                                                                                                            ...
                                                                                                            # Extract conclusions
                                                                                                            for pattern in self.extraction_patterns["conclusions"]:
                                                                                                                match = pattern.search(text)
                                                                                                                if match:
                                                                                                                    conclusion = match.group(1).strip()[:500]  # First 500 chars
                                                                                                                    if conclusion:
                                                                                                                        extracted["conclusions"].append(conclusion)

                                                                                                                        # Extract methodologies
                                                                                                                        for pattern in self.extraction_patterns["methodology"]:
                                                                                                                            match = pattern.search(text)
                                                                                                                            if match:
                                                                                                                                methodology = match.group(1).strip()[:500]
                                                                                                                                if methodology:
                                                                                                                                    extracted["methodologies"].append(methodology)

                                                                                                                                    # Extract metrics
                                                                                                                                    for pattern in self.extraction_patterns["metrics"]:
                                                                                                                                        for match in pattern.finditer(text):
                                                                                                                                            metric_name = pattern.pattern.split("[")[0].strip("\\")
                                                                                                                                            try:
                                                                                                                                                value = float(match.group(1))
                                                                                                                                                if metric_name not in extracted["metrics"]:
                                                                                                                                                    extracted["metrics"][metric_name] = []
                                                                                                                                                    extracted["metrics"][metric_name].append(value)
                                                                                                                                                    except:
                                                                                                                                                        pass

                                                                                                                                                    # Extract models
                                                                                                                                                    for pattern in self.extraction_patterns["models"]:
                                                                                                                                                        for match in pattern.finditer(text):
                                                                                                                                                            model = match.group(1)
                                                                                                                                                            extracted["models_mentioned"].add(model.upper())

                                                                                                                                                            # Convert set to list for JSON serialization
                                                                                                                                                            extracted["models_mentioned"] = list(extracted["models_mentioned"])

                                                                                                                                                            # Extract key findings (sentences with performance indicators)
                                                                                                                                                            ...
                                                                                                                                                            for sentence in sentences:
                                                                                                                                                                ...
                                                                                                                                                                for indicator in ["achieved", "outperformed", "improved", "accuracy", "return"]
                                                                                                                                                                    ...
                                                                                                                                                                    if len(sentence) < 200:  # Reasonable sentence length
                                                                                                                                                                    extracted["key_findings"].append(sentence.strip())
                                                                                                                                                                    if len(extracted["key_findings"]) >= 5:
                                                                                                                                                                        break
                                                                                                                                                                    ...
                                                                                                                                                                    def search_papers(self, query: str) -> List[Dict[str, Any]]:
                                                                                                                                                                        ...
                                                                                                                                                                        for paper_id, paper in list(self.paper_index["papers"].items()):
                                                                                                                                                                            score = 0

                                                                                                                                                                            # Check if query matches models
                                                                                                                                                                                ...
                                                                                                                                                                                if query_lower in model.lower():
                                                                                                                                                                                    ...
                                                                                                                                                                                    for conclusion in paper["extracted"].get("conclusions", []):
                                                                                                                                                                                        if query_lower in conclusion.lower():
                                                                                                                                                                                            ...
                                                                                                                                                                                            # Check key findings
                                                                                                                                                                                            for finding in paper["extracted"].get("key_findings", []):
                                                                                                                                                                                                if query_lower in finding.lower():
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if score > 0:
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        def get_paper_content(self, paper_id: str) -> Optional[str]:
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            text_file = PROCESSED_DIR / f"{paper_id}.txt"
                                                                                                                                                                                                            if text_file.exists():
                                                                                                                                                                                                                with open(text_file, "r", encoding="utf-8") as f:
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    # production the paper processor
                                                                                                                                                                                                                    if __name__ == "__main__":
                                                                                                                                                                                                                        logger.info("📚 TESTING PAPER PROCESSOR")
                                                                                                                                                                                                                        logger.info("=" * 50)

                                                                                                                                                                                                                        processor = PaperProcessor()

                                                                                                                                                                                                                        # production 1: Process a sample text as if from paper
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        Methodology:
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            Results:
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                Conclusion:
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    extracted = processor._extract_information(sample_text)
                                                                                                                                                                                                                                    logger.info(f"✅ Extracted {len(extracted['models_mentioned'])} models")
                                                                                                                                                                                                                                    logger.info(f"✅ Found {len(extracted['metrics'])} metrics")
                                                                                                                                                                                                                                    logger.info(f"✅ Extracted {len(extracted['conclusions'])} conclusions")

                                                                                                                                                                                                                                    # production 2: Save and index
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    with open(test_file, "w") as f:
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        if PAPER_INDEX_FILE.exists():
                                                                                                                                                                                                                                            logger.info(f"✅ Index saved to: {PAPER_INDEX_FILE}")
                                                                                                                                                                                                                                            logger.info(f"✅ Papers indexed: {len(processor.paper_index['papers'])}")

                                                                                                                                                                                                                                            # production 3: Search
                                                                                                                                                                                                                                            logger.info("\n3️⃣ Testing search# Production code implemented")
                                                                                                                                                                                                                                            results = processor.search_papers("LSTM")
